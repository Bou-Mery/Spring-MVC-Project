...
import com.ensaj.examsEnsaj.examsEnsaj.entites.Session; // Assurez-vous d'importer la classe Session
...
import jakarta.servlet.http.HttpSession; // Importez HttpSession
...
public class DepartementController {
    ...
    public String addDepartement(@ModelAttribute Departement departement) {
        ...
        return "redirect:/departements"; // Corrigez la redirection
    }
    ...
    public String showEditForm(@PathVariable int id, Model model) {
        ...
        return "layouts/departements/edit";
    }
    ...
    public String getDepartementEnseignants(@PathVariable int id, Model model) {
        Departement departement = departementService.getDepartementById(id);
        if (departement == null) {
            return "redirect:/departements"; // Corrigez la redirection
        }
